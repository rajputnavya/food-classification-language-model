# This is the main processing pipeline script orchestrating the entire process:
# 1. Ensures NLTK data is available.
# 2. Creates necessary directories.
# 3. Parses the PDF files line by line and saves them to JSONL files.
# 4. Extracts sentences and splits them into chunks, saving to a new JSONL file.
# 5. Merges all processed JSONL files into one final output file for MLM.
# 6. Creates the final output file for NSP.
# 7. Cleans up the temporary directories after successful processing.
...
from com.mhire.data_processing.nsp_data_generator import NSPGenerator
